				...
				<div class="base-lista">
					<div>
						<div class="text-end d-flex">
							<a href="<?php echo URL_BASE."parente/create" ?>" class="btn btn-verde d-inline-block mb-2 mx-1"><i class="fas fa fa-plus-circle" aria-hidden="true"></i> Cadastrar Usuário</a>
						...
						<div class="rows">
								<div class="col-4">
									<select name="txt_id_empresa">
										...
										<option value="6">Parentesco</option>
									</select>
								</div>
								<div class="col-6">
